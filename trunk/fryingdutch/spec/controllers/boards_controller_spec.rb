...
describe BoardsController do
  ...
  describe "responding to GET show" do
    ...
    it "should expose the requested board as @board" do
      Board.should_receive(:find_by_permalink).with("37").and_return(mock_board)
      get :show, :id => "37"
  ...
  describe "responding to PUT update" do
    ...
    describe "with valid params" do
      ...
      it "should expose the requested board as @board" do
        Board.stub!(:find_by_permalink).and_return(mock_board(:update_attributes => true))
        put :update, :id => "1"
        assigns(:board).should equal(mock_board)
      end
    ...
    describe "with invalid params" do
      ...
      it "should expose the board as @board" do
        Board.stub!(:find_by_permalink).and_return(mock_board(:update_attributes => false))
        put :update, :id => "1"
        assigns(:board).should equal(mock_board)
      end
  ...
  describe "responding to DELETE destroy" do
    ...
    it "should redirect to the boards list" do
      Board.stub!(:find_by_permalink).and_return(mock_board(:destroy => true))
      delete :destroy, :id => "1"
